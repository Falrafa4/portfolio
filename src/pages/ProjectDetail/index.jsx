        ...
        <div className="flex flex-wrap gap-4 mt-2">
          {project.demoUrl && (
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-primary hover:bg-primary-hover text-white text-sm font-semibold rounded-md shadow transition-colors"
            >
          ...
          {project.githubUrl && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-background border border-border hover:bg-black/10 dark:hover:bg-white/10 text-text-main text-sm font-semibold rounded-md shadow-sm transition-colors"
            >
