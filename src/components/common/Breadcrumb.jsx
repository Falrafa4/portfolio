...
export default function Breadcrumb() {
  ...
  return (
    <div className="flex-1 flex items-center border border-border rounded-md bg-background px-3 py-1 text-sm text-text-muted shadow-sm min-w-0">
      <Link to="/" className="hover:bg-black/10 dark:hover:bg-white/5 p-1 rounded transition-colors flex items-center">
        <Home size={14} />
      </Link>
      ...
      <div className="flex items-center overflow-x-auto no-scrollbar whitespace-nowrap min-w-0">
        <Link to="/" className="hover:bg-black/10 dark:hover:bg-white/5 px-1.5 py-0.5 rounded transition-colors text-text-main">
          Home
        </Link>
          ...
          return (
            <div key={to} className="flex items-center">
              ...
              {isLast ? (
                ...
                <Link to={to} className="hover:bg-black/10 dark:hover:bg-white/5 px-1.5 py-0.5 rounded transition-colors text-text-main truncate">
                  {label}
                </Link>
              )}
            </div>
